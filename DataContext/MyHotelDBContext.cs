...
namespace dotnetangular.DataContext
{
    public class MyHotelDbContext : DbContext
    {
        public static string DbConnectionString = @"Server=CND625958H\MSSQLSERVER02; Database=MyHotelDb; Trusted_Connection=True;";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //ROOMS
            modelBuilder.Entity<Room>().HasData(new Room(101, "yellow-room", dotnetangular.Enum.RommStatus.Available, false) { Id = 1 });
            modelBuilder.Entity<Room>().HasData(new Room(102, "blue-room", dotnetangular.Enum.RommStatus.Available, false) { Id = 2 });
            modelBuilder.Entity<Room>().HasData(new Room(103, "white-room", dotnetangular.Enum.RommStatus.Unavailable, false) { Id = 3 });
            modelBuilder.Entity<Room>().HasData(new Room(104, "black-room", dotnetangular.Enum.RommStatus.Unavailable, false) { Id = 4 });
